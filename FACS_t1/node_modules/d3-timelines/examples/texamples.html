...
<head>
  ...
  <script type="text/javascript">
    window.onload = function() {
      ...
      var labelTestData = [
        {label: "person a", times: [{"lp": "a.1 This is very very very long", "starting_time": 1355752800000, "ending_time": 1355759900000}, {"lp": "a.2", "starting_time": 1355767900000, "ending_time": 1355774400000}]},
        {label: "person b", times: [{"lp": "b.1", "starting_time": 1355759910000, "ending_time": 1355761900000}, ]},
        {label: "person c", times: [{"lp": "c.1", "starting_time": 1355761910000, "ending_time": 1355763910000}]}
      ];
      ...
      function timelineCircle() {
        ...
        var svg = d3.select("#timeline2").append("svg").attr("width", 800)
          .datum(testData).call(chart);
      }
      ...
      function timelineHover() {
        var chart = d3.timelines()
          ...
          // datum is the id object
            var div = $('#hoverRes');
            div.find('#name').text(datum.times[i].lp);
//          })
...
<body>
  ...
  <div>
    <h3>A stacked timeline with hover events</h3>
